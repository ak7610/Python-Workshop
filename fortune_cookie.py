...
def create_fortune_cookie_message(how_many_lucky_numbers: int) -> str:
    ...
    ''' AmanK- Can't call qty_lucky_numbers here as its a locally defined variable in main() so I'd now go in
    main() and define var there to call qty_lucky_numbers'''
...
def main():
    ...
    var = print(generate_lucky_numbers(qty_lucky_numbers))
